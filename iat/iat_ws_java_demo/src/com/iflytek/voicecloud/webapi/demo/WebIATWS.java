...
public class WebIATWS extends WebSocketListener {
    ...
    //private static final String hostUrl = "wss://iat-api.xfyun.cn/v2/iat"; //中英文，http url 不支持解析 ws/wss schema
    // private static final String hostUrl = "https://iat-niche-api.xfyun.cn/v2/iat";//小语种
	private static final String appid = "898a0b0c"; //在控制台-我的应用获取
	private static final String apiSecret = "NGU2NGY4YmVhYTg5NzE2ZjlkYzhiMDhk"; //在控制台-我的应用-语音听写（流式版）获取
	private static final String apiKey = "3127f74200187b000bde672967b4d4a4"; //在控制台-我的应用-语音听写（流式版）获取
